...
with open(stop_times_file, 'r', encoding='utf-8') as file:
    ...
    for row in reader:
        ...
        stops_list.append(stope_time_data)
...
with open(stops_file, 'r', encoding='utf-8') as file:
    ...
    for row in reader:
        ...
        for data in stops_list:
            stops_data_dict[stop_id]["listArrivalsTime"].append(data)
        stops_time_list.append(stops_data_dict[stop_id])
...
with open(trips_file, 'r', encoding='utf-8') as file:
    ...
    for row in reader:
        ...
        for data in stops_time_list:
            route_data_dict[route_id]["listeArrets"].append(data)
